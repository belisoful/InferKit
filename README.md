...
- **[Audio](Docs/model-index.md#audio)** — Whisper (tiny–large-v3), Parakeet-TDT, Demucs v2 / HT Demucs, speech denoiser, MossFormer2 SE, Conv-TasNet, MarbleNet and Silero VAD, PANNs tagger, DAC, SNAC
