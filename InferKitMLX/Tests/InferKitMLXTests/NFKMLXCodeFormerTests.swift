...
//  InferKitMLXTests
//
//  The VQGAN + Transformer face restorer. The forward, the code prediction, and the weight
//  round-trip evaluate MLX arrays, so they skip without a Metal library for MLX (see
