...
//  InferKitMLXTests
//
//  The Demucs-U-Net speech denoiser (single output channel). The forward and round-trip evaluate
//  MLX arrays, so they skip without a Metal library for MLX (see Tools/mlx-metallib.sh).
//
