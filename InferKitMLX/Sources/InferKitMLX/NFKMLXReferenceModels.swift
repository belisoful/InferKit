...
public final class NFKMLXReferenceModels: NSObject {
    ...
    @objc public static func registerAll() {
        ...
        NFKMLXAdaIN.register()
        NFKMLXCLIP.register()
        NFKMLXRVM.register()
        NFKMLXCodeFormer.register()
        NFKMLXZeroDCE.register()
        NFKMLXZeroDCEPlus.register()
        NFKMLXMODNet.register()
        NFKMLXYOLO.register()
        NFKMLXYOLOGenerations.register()
        NFKMLXRTDetr.register()
        NFKMLXRFDetr.register()
        NFKMLXRFDetrSegmentation.register()
        NFKMLXBiRefNet.register()
        ...
        NFKMLXPose.register()
        NFKMLXVitPose.register()
        NFKMLXDDColor.register()
        ...
        NFKMLXMetricGANPlus.register()
        NFKMLXCMGAN.register()
        NFKMLXFRCRN.register()
        NFKMLXMossFormer2SRFactory.register()
        NFKMLXNUWave2.register()
        NFKMLXApollo.register()
        ...
        NFKMLXResembleEnhanceFactory.register()
        ...
        NFKMLXCosmosTokenizer.register()
        NFKMLXMusic3.register()
        NFKMLXBasicPitch.register()
        NFKMLXAllInOne.register()
        NFKMLXMuScriptor.register()
        NFKMLXHFTTransformer.register()
    }
